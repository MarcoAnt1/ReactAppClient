...
export default function NewBook() {
    ...
    async function loadBook() {
        try {
            const response = await api.get(`v1/api/book/${bookId}`, authorization)
    ...
    async function saveOrUpdate(e) {
        ...
        try {
            if(bookId === '0') {
                await api.post('v1/api/Book', data, authorization);
            } else {
                data.id = id;
                await api.put('v1/api/Book', data, authorization);
            }
